...
//       const { lokasi, polusi, time, post_content } = data[key];
...
get(user_ref).then((snapshot) => {
  ...
  const secondLatestData = lokasi1Data[1];
  let kedua = secondLatestData.polusi;
  console.log(kedua);
      ...
      datasets: [
        {
          ...
          fill: true,
          data: [150, 400, 500, 400, 500, 400, 1000],
          maxBarThickness: 6,
        },
        {
          label: "LokasiKedua",
          ...
          fill: true,
          data: [kedua, 90, 40, 140, 290, 290, 340],
          maxBarThickness: 6,
        },
        {
          label: "LokasiKetiga",
          ...
          backgroundColor: gradientStroke2,
          fill: true,
          data: [350, 90, 340, 440, 290, 290, 500],
          maxBarThickness: 6,
        },
      ],
    },
